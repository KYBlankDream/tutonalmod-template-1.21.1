...
public class ModItems {
    ...
    {
        //return Registry.register(Registries.ITEM, (RegistryKey.of(Registries.ITEM.getKey(), Identifier.of(TutonalMod.MOD_ID,id))), item);
        return Registry.register(Registries.ITEM,Identifier.of(TutonalMod.MOD_ID,id),item);
    }
    ...
    public static void registerModItems(){
        ...
        TutonalMod.LOGGER.info("Register Item");
    }
}
